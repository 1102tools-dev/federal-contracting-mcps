...
| [GSA Per Diem](servers/gsa-perdiem-mcp) | Lodging and meals-and-incidental-expense rates by locality. | 7 | 541 | ZIP/state/M&IE keyless from bundled GSA files; personal key recommended for city lookups; keyless hosted edition coming soon |
