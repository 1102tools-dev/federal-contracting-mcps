...
Acquisition.gov has [179 offline tests and live evidence across all five tools](servers/acquisition-gov-mcp/testing.md), including P0–P3 coverage for HTML/PDF parsing and transport boundaries.
