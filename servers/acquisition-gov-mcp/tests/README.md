...
The 1.0.8 suite has 236 offline cases and three opt-in live tests. The constrained-runtime workflow tests the production image with the current basic allocation (1/4 CPU and 1 GiB RAM), including the actual NSF Part 1 PDF and full Part 52 HTML.
